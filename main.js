...
let contractAddress = '0x4B7b04B48040aC057e262ed9594d6f4553fdD2c9';
let contractabi = [
    {
      "inputs": [
        {
...
const voteStatus = async() => {
  if(WALLET_CONNECTED != 0){
    ...
    status.innerHTML = currentStatus == 1 ? "Voting is currenly open" : "Voting is finished";
...
const addVote = async() => {
  if(WALLET_CONNECTED != 0){
    ...
    const tx = await contractInstance.vote(name.value, 50);
    await tx.wait();
